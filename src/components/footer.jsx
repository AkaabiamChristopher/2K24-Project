...
function Footer() {
    return (
        <footer className="bg-gray-800 text-white w-full pt-12 pb-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {['home', 'about', 'faculty', 'events', 'gallery'].map(section => (
                                <li key={section}>
                                    <a href={`#${section}`} className="text-gray-300 hover:text-white">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-300 break-words">
                            <li>Kaduna, Nigeria</li>
                            <li>akaabiamchristopher161882@gmail.com</li>
                            <li>+234 9025731177 / 9164876996</li>
                        </ul>
                    </div>
                    <div>
